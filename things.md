...
<div class="page-width" style="padding-top: clamp(84px, 13vw, 150px);">
  <section class="work-section" aria-labelledby="work-title" style="padding-top: 0;">
    <div class="section-heading">
      <div>
        <p class="eyebrow">03 / PUBLIC WORK</p>
        <h2 id="work-title">Things I have made.</h2>
      </div>
